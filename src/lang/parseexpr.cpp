...
std::ostream& hcut::lang::operator<<(std::ostream& out, const ChrExpr& stmt)
{
	return out << "'" << stmt.Value << "'";
}

std::ostream& hcut::lang::operator<<(std::ostream& out, const IdExpr& stmt)
{
	return out << stmt.Value;
}

std::ostream& hcut::lang::operator<<(std::ostream& out, const IntExpr& stmt)
{
	return out << stmt.Value;
}
...
hcut::lang::ExprPtr hcut::lang::Parser::NextExpr()
{
	return NextSelExpr();
}
...
hcut::lang::ExprPtr hcut::lang::Parser::NextBinExpr()
{
	return NextBinLogExpr();
}
