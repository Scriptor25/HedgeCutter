...
bool hcut::lang::Parser::AtEOF() const { return m_Token.Type == TK_EOF; }

bool hcut::lang::Parser::At(const std::string &value) const { return m_Token.Value == value; }

bool hcut::lang::Parser::At(TokenType type) const { return m_Token.Type == type; }
