...
std::ostream& hcut::lang::operator<<(std::ostream& out, const BrkStmt& stmt)
{
	return out << "break";
}

std::ostream& hcut::lang::operator<<(std::ostream& out, const DefStmt& stmt)
{
	return out << "def " << stmt.Symbol;
}
...
std::ostream& hcut::lang::operator<<(std::ostream& out, const ResStmt& stmt)
{
	return out << "result " << stmt.Result;
}
